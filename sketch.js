...
const data = await response.json();
    ...
    aiMotto = "INVALID API KEY";
    aiGeneratedResult = "To view your data you need to connect to a valid CHATGPT-API Key at the home page. Contact Leekaienzane2000@gmail.com for more assistant.";
